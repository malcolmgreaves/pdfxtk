...
public class FileFunctions {
	...
	/**
	 * This method uses a FileReader to populate a buffer of chars. The chars are appended to a StringBuffer
	...
	/**
	 * his method supposes that a word is a space-delimited String. This would be trivial but for
